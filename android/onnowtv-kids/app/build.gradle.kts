...
android {
    namespace  = "tv.onnowtv.kids"
    compileSdk = 34

    defaultConfig {
        applicationId = "tv.onnowtv.kids"
        minSdk        = 23
        targetSdk     = 34
...
dependencies {
    ...
    // Native ExoPlayer (media3) — same as FTA.  The Kids React
    // `FullScreenPlayer` hands HLS URLs off to native via the
    // OnNowKids JS bridge so playback stays smooth on TV hardware.
