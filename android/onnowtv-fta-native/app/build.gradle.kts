...
android {
    namespace  = "tv.onnowtv.fta_native"
    compileSdk = 34

    defaultConfig {
        applicationId = "tv.onnowtv.fta.recycler"
        minSdk        = 23
        targetSdk     = 34
    ...
    signingConfigs {
        create("release") {
            ...
            if (ksPath != null && file(ksPath).exists()) {
                storeFile = file(ksPath); storePassword = ksPass
                keyAlias  = keyAls;       keyPassword   = keyPas
            }
        }
    }
...
dependencies {
    ...
    // ExoPlayer (media3) — HLS playback for the FTA `.m3u8` feeds.
