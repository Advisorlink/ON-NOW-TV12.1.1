...
android {
    namespace  = "tv.onnowtv.trivia"
    compileSdk = 34

    defaultConfig {
        applicationId = "tv.onnowtv.trivia"
        minSdk        = 23
        targetSdk     = 34
    ...
    // Fall back to the debug signing config when no release keystore is
    // available so CI packaging always succeeds (same as the other apps).
