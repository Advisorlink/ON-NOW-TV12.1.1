...
class ExoPlayerActivity : AppCompatActivity() {
    ...
    companion object {
        const val EXTRA_URL        = "tv.onnowtv.fta.EXTRA_URL"
        const val EXTRA_TITLE      = "tv.onnowtv.fta.EXTRA_TITLE"
        const val EXTRA_SUBTITLE   = "tv.onnowtv.fta.EXTRA_SUBTITLE"
        const val EXTRA_POSTER_URL = "tv.onnowtv.fta.EXTRA_POSTER_URL"
    }
